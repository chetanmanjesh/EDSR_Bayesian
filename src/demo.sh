...
python main.py --model EDSR --scale 2 --patch_size 96 --save edsr_baseline_x2 --reset --data_train DIV2K --data_test DIV2K
#/home/ubuntu/Real-ESRGAN-Video-Batch-Process/Real-ESRGAN/data/datasets/DIV2K/DIV2K_train_HR
